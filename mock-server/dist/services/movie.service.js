...
exports.readMoviesCount = exports.deleteMovies = exports.updateMovies = exports.createMovies = exports.readMoviesById = exports.readAllMovies = void 0;
/* eslint-disable no-useless-catch */
// Follow CRUD convention for name methods
const index_1 = __importDefault(require("../database/index"));
const readAllMovies = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const readMoviesById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const createMovies = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const updateMovies = (type, id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!id || !payload || !Object.keys(payload).length)
            return;
...
const deleteMovies = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payloadIndex = index_1.default.movies.findIndex((item) => item.id === id);
        if (payloadIndex > -1) {
            // remove at index
...
const readMoviesCount = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
