...
import { GetShorterText } from "components/GetShortText";
import { RadioOptions } from "containers/config/findingAndRecommendations/findingsAndRecommendationsForm/FindingsUtils";
                    ...
                    return (
                      ...
                      >
                        ...
                        {[...headCells]?.map((hc, index) => {
                          ...
                          return (
                            <TableCell className={handleTableCellVisibility(hc.id)} key={index}>
                              {/* {GetValue(row, hc?.id)} */}
                              <GetValue
                                row={row}
                                columnName={hc?.id}
