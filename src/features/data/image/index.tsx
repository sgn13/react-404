...
const stepData = [
  { id: 3, name: "Annotate", position: 3, icon: "" },
  { id: 1, name: "Project Name", position: 1, icon: "" },
  { id: 2, name: "Upload Images", position: 2, icon: "" },
  { id: 4, name: "Ratio", position: 4, icon: "" },
  { id: 5, name: "Publish", position: 5, icon: "" },
];
        ...
        {(props: FormikProps<any>) => {
          ...
          return (
            <form
              ...
              style={{ margin: "1rem 0" }}
            >
              <Hidden show={nextStep?.name === "Project Name"}>
                <ProjectName
                  name="projectName"
              ...
              <Hidden show={nextStep?.name === "Upload Images"}>
                <UploadImages
                  name="images"
                  setFieldValue={setFieldValue}
                  values={values}
