...
import Feature from "src/assets/icons/sidebar/feature.png";
import Settings from "src/assets/icons/sidebar/settings.png";
    ...
    children: [
      {
        ...
        label: "Feature PY 1",
        location: "top",
        path: app.featureEngieering.feature1,
        role: "user",
        Permission: undefined,
        collasped: false,
      },
      {
        ...
        label: "Feature PY 2",
        location: "top",
        path: app.featureEngieering.feature2,
        role: "user",
        Permission: undefined,
        collasped: false,
      },
      {
        ...
        label: "Feature PY 3",
        location: "top",
        path: app.featureEngieering.feature3,
        role: "user",
        Permission: undefined,
        collasped: false,
      },
