...
import { fetchUser, setUser, updateUser } from "store/user/actions";
import styled from "theme/styled";
import LogoIcon from "assets/logo.png";
import shadows from "constants/css/shadows";
import Input from "components/Input/Input";
import Button from "components/Button/Button";
import { Buffering, ProgressLoader } from "components/Spinner/Spinner";
import { downloadFile, resetUploadState, uploadFile } from "store/app/actions";
              ...
              <VideoPage style={{ width: "50vw" }}>
                <VideoContainerWrapper>
                  <VideoContainer>
                    ...
                    <Player controls playsInline isRemoteStream={true} preload="auto" width="100%">
